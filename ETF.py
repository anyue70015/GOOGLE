...
def load_sp500_tickers():
    ...
    return [
         "AAPL", "MSFT", "NVDA", "GOOGL", "GOOG", "AMZN", "META", "AVGO", "BRK.B", "LLY",
        "TSLA", "JPM", "V", "UNH", "XOM", "MA", "PG", "JNJ", "HD", "MRK",
        "COST", "ABBV", "WMT", "NFLX", "BAC", "ORCL", "CVX", "CRM", "KO", "AMD",
        "TMO", "ACN", "PEP", "LIN", "ADBE", "MCD", "CSCO", "WFC", "TXN", "ABT",
        "QCOM", "GE", "INTU", "VZ", "AMGN", "CAT", "DHR", "PM", "IBM", "NOW",
        "UNP", "INTC", "PFE", "SPGI", "RTX", "UBER", "MU", "ISRG", "LOW", "BKNG",
        "HON", "COP", "LRCX", "BLK", "ELV", "TJX", "VRTX", "SYK", "C", "REGN",
        "MDT", "BA", "PGR", "KLAC", "ADP", "PANW", "DE", "LMT", "ADI", "SBUX",
        "PLD", "MMC", "BX", "FI", "AMAT", "CB", "SCHW", "BSX", "SO", "GILD",
        "BMY", "TMUS", "ICE", "ZTS", "MO", "CME", "DUK", "CL", "APD", "TT",
        "MCK", "SHW", "EOG", "FCX", "ITW", "SLB", "EQIX", "TGT", "PH", "EMR",
        "BDX", "NOC", "MSI", "GD", "MMM", "CSX", "WM", "HCA", "PYPL", "ECL",
        "ANET", "USB", "OXY", "PSX", "NSC", "RSG", "CARR", "FDX", "PCAR", "AJG",
        "MAR", "ROP", "FTNT", "COF", "AON", "AZO", "KMB", "GM", "ADSK", "JCI",
        "TEL", "DXCM", "PAYX", "TFC", "KDP", "MSCI", "IDXX", "CTAS", "AIG", "EW",
        "HLT", "IQV", "NEM", "STZ", "DHI", "O", "EXC", "PRU", "SRE", "VLO",
        "HUM", "WMB", "AFL", "BIIB", "KHC", "DLR", "SPG", "MET", "ALL", "LHX",
        "ODFL", "URI", "VRSK", "FAST", "PEG", "CCI", "LEN", "GWW", "CTSH", "KR",
        "EXR", "IR", "RCL", "CMI", "ACGL", "XEL", "EA", "LVS", "OKE", "COR",
        "PPG", "D", "KVUE", "FICO", "NUE", "MPWR", "ROST", "CPRT", "MNST", "GEHC",
        "IT", "DAL", "HPQ", "HAL", "ED", "KMI", "SYY", "CTVA", "GLW", "GIS",
        "CNC", "STT", "YUM", "WST", "WTW", "CMG", "EFX", "IRM", "RMD", "MLM",
        "VMC", "CSGP", "CDW", "ANSS", "TDG", "DFS", "FITB", "ULTA", "ON", "ZBH",
        "EIX", "CHTR", "MTD", "TTWO", "TSCO", "WEC", "FANG", "DLTR", "HPE", "EBAY",
        "ALGN", "NTAP", "WDC", "TROW", "MTB", "GPN", "XYL", "DVN", "HIG", "VRSN",
        "BRO", "WAT", "ILMN", "DOV", "LYB", "HUBB", "BALL", "TYL", "PPL", "STLD",
        "BR", "HBAN", "TER", "INVH", "ARE", "ES", "STE", "ETR", "DTE", "FE",
        "AWK", "FTV", "ROL", "GPC", "AXON", "ALB", "MKC", "CLX", "CHD", "LII",
        "PHM", "TXT", "IEX", "JBHT", "MAS", "LKQ", "NDSN", "SWK", "POOL", "TRGP",
        "DPZ", "HST", "J", "CF", "L", "WRB", "CBOE", "PKG", "EXPD", "AVY", "BG",
        "IP", "SNA", "AMCR", "TRMB", "LDOS", "K", "ENPH", "AKAM", "JBL", "UDR",
        "EQR", "VTR", "MAA", "ESS", "WY", "WPC", "HII", "TAP", "CPT", "REG",
        "BXP", "FFIV", "INCY", "TECH", "GNRC", "QRVO", "HSIC", "AOS", "DAY", "PODD",
        "CTLT", "SOLV", "TFX", "WBA", "BIO", "NRG", "BBWI", "CZR", "KMX", "EXE"
    ]
