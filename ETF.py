...
def load_sp500_tickers():
    # 2025年12月最新S&P500硬编码列表（避免网络失败）
    return [
        "AAPL","MSFT","NVDA","GOOGL","AMZN","META","AVGO","TSLA","BRK.B","LLY","JPM","V","WMT","XOM","UNH",
        "MA","PG","JNJ","HD","MRK","COST","ABBV","ORCL","CRM","BAC","NFLX","AMD","KO","TMO","CVX","ACN",
        "LIN","ADBE","PEP","MCD","CSCO","ABT","GE","WFC","QCOM","TXN","INTU","VZ","AMGN","IBM","CAT","DHR",
        "PM","NOW","UNP","INTC","PFE","SPGI","RTX","UBER","MU","ISRG","LOW","BKNG","HON","COP","LRCX","BLK",
        "ELV","TJX","VRTX","SYK","C","REGN","MDT","BA","PGR","KLAC","ADP","PANW","DE","LMT","ADI","SBUX",
        "PLD","MMC","BX","FI","AMAT","CB","SCHW","BSX","SO","GILD","BMY","TMUS","ICE","ZTS","MO","CME",
        "DUK","CL","APD","TT","MCK","SHW","EOG","FCX","ITW","SLB","EQIX","TGT","PH","EMR","BDX","NOC","MSI",
        "GD","MMM","CSX","WM","HCA","PYPL","ECL","ANET","USB","OXY","PSX","NSC","RSG","CARR","FDX","PCAR",
        "AJG","MAR","ROP","FTNT","COF","AON","AZO","KMB","GM","ADSK","JCI","TEL","DXCM","PAYX","TFC","KDP",
        "MSCI","IDXX","CTAS","AIG","EW","HLT","IQV","NEM","STZ","DHI","O","EXC","PRU","SRE","VLO","HUM",
        "WMB","AFL","BIIB","KHC","DLR","SPG","MET","ALL","LHX","ODFL","URI","VRSK","FAST","PEG","CCI","LEN",
        "GWW","CTSH","KR","EXR","IR","RCL","CMI","ACGL","XEL","EA","LVS","OKE","COR","PPG","D","KVUE","FICO",
        "NUE","MPWR","ROST","CPRT","MNST","GEHC","IT","DAL","HPQ","HAL","ED","KMI","SYY","CTVA","GLW","GIS",
        "CNC","STT","YUM","WST","WTW","CMG","EFX","IRM","RMD","MLM","VMC","CSGP","CDW","ANSS","TDG","DFS",
        "FITB","ULTA","ON","ZBH","EIX","CHTR","MTD","TTWO","TSCO","WEC","FANG","DLTR","HPE","EBAY","ALGN",
        "NTAP","WDC","TROW","MTB","GPN","XYL","DVN","HIG","VRSN","BRO","WAT","ILMN","DOV","LYB","HUBB","BALL",
        "TYL","PPL","STLD","BR","HBAN","TER","INVH","ARE","ES","STE","ETR","DTE","FE","AWK","FTV","ROL","GPC",
        "AXON","ALB","MKC","CLX","CHD","LII","PHM","TXT","IEX","JBHT","MAS","LKQ","NDSN","SWK","POOL","TRGP",
        "DPZ","HST","J","CF","L","WRB","CBOE","PKG","EXPD","AVY","BG","IP","SNA","AMCR","TRMB","LDOS","K",
        "ENPH","AKAM","JBL","UDR","EQR","VTR","MAA","ESS","WY","WPC","HII","TAP","CPT","REG","BXP","FFIV",
        "INCY","TECH","GNRC","QRVO","HSIC","AOS","DAY","PODD","CTLT","SOLV","TFX","WBA","BIO","NRG","BBWI",
        "CZR","KMX"
    ]
...
st.caption("2025最新版 | 已加入热门ETF | PF7≥3.6 或 7日≥68% | 简洁专注短线")
