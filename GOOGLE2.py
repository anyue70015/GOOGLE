...
my_30 = [
    ...
    "AHR", "ATRO", "GLW", "CMI", "APH", "SMH", "TPR", "SOXX", "COR", "CAH",
    "HCA", "TSM", "NESR", "RGLD", "OKLO", "SMR", "URNM", "URA", "NVDA", "GOOG",
    "TTMI", "TMC", "SVM", "SKE", "RVMD", "RGC", "RDW", "POWL", "PL", "ONDS",
    "LMND", "HYMC", "HL", "FTAI", "EXK", "ERAS", "DFTX", "CDE", "ASTS", "APLD", "NEM"
]
